        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
          {products.map((product) => (
            ...
            >
              ...
              <button className="bg-orange-500 text-white px-4 py-2 mt-4 rounded-full shadow-md hover:bg-orange-600 transition duration-300 w-full">
                Add to Cart
              </button>
            </div>
          ))}
          ...
          {["Phone", "Laptop", "Headphones", "TV"].map((product, idx) => (
            ...
            >
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-yellow-500 mt-2">⭐ {4.5 + idx * 0.1}</p>
